...
class SalesCenterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $data['image'] = $imageName; // Add image name to data
            }
    
            // Create the SalesCenter using mass assignment
            SalesCenter::create($data);
    ...
    public function update(Request $request, $id)
    {
     ...
     // Handle image upload for salesCenter
if ($request->hasFile('image')) {
    // Delete old image if it exists
    if ($salesCenter->image) {
        \Storage::delete('images/' . $salesCenter->image);
    }
    ...
    // Set the new image name directly on the salesCenter model
    $salesCenter->image = $imageName;
}
