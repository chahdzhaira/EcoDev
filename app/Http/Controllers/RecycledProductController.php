    ...
    public function index(Request $request, $salesCenterId)
{
    ...
    public function store(Request $request, $salesCenterId)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $recycledProduct->image = $imageName; // Assign the image name to the product
        }
...
if ($request->hasFile('image')) {
    ...
    if ($recycledProduct->image) {
        \Storage::delete('images/' . $recycledProduct->image);
    }
    ...
    $recycledProduct->image = $imageName;
}
