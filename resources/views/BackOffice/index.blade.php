  ...
  <body class="landing-page">
    ...
    <section class="landing-hero">
      ...
      <div class="landing-hero-content">
        ...
        <div><a class="btn btn-primary me-4" href="{{route('dashboard')}}" >Demo</a><a class="btn btn-primary" href="https://github.com/pratikborsadiya/vali-admin" target="_blank" rel="noopener">GitHub</a></div><img src="{{Vite::asset('resources/assets/img/banner.jpg')}}" class="landing-hero-banner" >
      </div>
    </section>
