<!-- <form action ="{{route('publication.update', $publication->id) }}" method="POST">
    ...
    image : <input type="text" name = "image" value="{{ $publication->image }}">
    content : <input type="text" name = "content"  placeholder="Content" value="{{ $publication->content }}">
    category : <input type="text" name = "category" value="{{ $publication->category }}">
...
<html lang="en">
 ...
 <header class="app-header"><a class="app-header__logo" href="{{route('indexBack')}}">EcoCycle</a>
    ...
    <main class="app-content">
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Update publication</h3>
                <div class="tile-body">
                    ...
                    @method('PUT')
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name = "title" value="{{  $publication->title }}"  placeholder="Enter the title">
                            @error('title')
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <input class="form-control" type="file" name = "image" value="{{ $publication->image }}" >
                        </div> -->
                        <div class="mb-3">
                            <label class="form-label">Image</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" rows="6" placeholder="Enter the description ">{{ $publication->description }}</textarea>
                            @error('description')
                                <div class="form-control-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name = "category" value="{{ $publication->category }}"  placeholder="recycling, reducing waste ... ">
                            @error('category')
                                <div class="form-control-feedback text-danger">{{ $message }}</div>
                            @enderror
                        </div>
