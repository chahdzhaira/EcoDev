	   ...
	   <div class="footer_1 row">
		...
		<div class="col-md-4">
		 <div class="footer_1i row">
		   <div class="col-md-6"><img src="{{Vite::asset('resources/assets/img/35-3.jpg')}}" class="w-100"> </div>
		   <div class="col-md-6"><img src="{{Vite::asset('resources/assets/img/35-1.jpg')}}" class="w-100"> </div>
		   <div class="col-md-6"><img src="{{Vite::asset('resources/assets/img/35-2.jpg')}}" class="w-100"> </div>
		   <div class="col-md-6"><img src="{{Vite::asset('resources/assets/img/35-4.jpg')}}" class="w-100"> </div>
		 </div>
		</div>
		<div class="col-md-4">
		 <div class="footer_1i">
